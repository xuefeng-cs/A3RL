...
class SACLearner(Agent):
    ...
    def target_critic_advantage(self, batch: DatasetDict) -> jnp.ndarray:
        key, key2, key3, key4, rng = jax.random.split(self.rng, 5)
        ...
        num_samples = 20
        sampled_actions = policy_dist.sample(sample_shape=(num_samples,), seed=key3)
        sampled_qs = jax.vmap(
        ...
        print(f'Shape of sampled_qs: {sampled_qs.shape}')
        ...
        print(f'Shape of sampled_vs: {sampled_vs.shape}')
